...
public class CategoryServiceImpl implements CategoryService {
	...
	@Override
	public CategoryResponse getAllCategoriess(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
		Sort sortByAndOrder = sortOrder.equalsIgnoreCase("asc") ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();

		Pageable pageDetails = PageRequest.ofSize(pageSize).withPage(pageNumber).withSort(sortByAndOrder);
